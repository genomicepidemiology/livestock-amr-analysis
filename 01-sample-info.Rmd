...
# Change the wording from 'chicken' to 'broiler' throughout manuscript.
#livestock_sample_metadata$species = gsub("Chicken", "Broiler", livestock_sample_metadata$species)
#names(plot_colours$species)[3] = "Broiler"
```
